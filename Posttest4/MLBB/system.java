    ...
    public void cari () throws IOException {
        ...
        if(hasil == -1) {
            ...
            System.out.println("""
                ...
                System.out.println("\t" + "Warna Skin Hero         : " + ( listSkin.get(hasil)).getWarna());
                System.out.println("\t" + "Harga Skin Hero         : " + ( listSkin.get(hasil)).getHargaSkin());
