...
final class PaintedSkin extends Skin {
    ...
    public PaintedSkin(String Nama, String Role, String Spesialist, int Harga, String Emblem, int HargaEmblem, String WarnaSkinPainted, int HargaSkinPainted) {
        super(Nama, Role, Spesialist, Harga, Emblem, HargaEmblem);
